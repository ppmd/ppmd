...
class MDMPI(object):
    ...
    def set_periods(self, p=None):
        ...
        '''
        assert p != None, "Error no periods passed"
        self._p = p
...
def xyz_write(dirname='./output', filename='out.xyz', X=None, title='A', sym='A', N_mol=1, rename_override=False):
    '''
